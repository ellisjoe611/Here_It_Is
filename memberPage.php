...
echo '<div class="row">';
					...
					<!-- 좋아요/싫어요/즐겨찾기 버튼-->
					<div class="likeArea">
					<div class="likeBtn" id="likes<?=$product['id'] ?>">
...
echo '<div class="row">';
			...
			<h5>상품코드 : <?=$product['id'] ?>
			    <!-- 좋아요/싫어요/즐겨찾기 버튼-->
			<button type="button" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-thumbs-up" ></button></span> <span class="badge"><?=$product['like_hate'] ?>
			</span>
			</h5>
			</div>
			<?php $rown++;
