...
if($_POST["action"] == "Insert")
{
   ...
   $query = "INSERT INTO product (p_id, p_num, cate1, cate2, name, expiry_day, price, productPhoto)
   VALUES ('".$p_id."','".$p_num."', '".$cate1."', '".$cate2."', '".$name."', '".$expiry_day."', '".$price."', '".$productPhoto."')";
...
$output["productPhoto"] = '<img src="/myservice/images/product/'.$row["productPhoto"].'" class="img-thumbnail" width="50" height="35" />';
}
...
, name = '".$name."' , expiry_day = '".$expiry_day."' , price = '".$price."' , productPhoto = '".$productPhoto."'
